...
type AuthCheckerClient interface {
	...
	GetUser(ctx context.Context, in *UUIDUser, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authCheckerClient) GetUser(ctx context.Context, in *UUIDUser, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/AuthChecker/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthCheckerServer interface {
	// получение пользователя по UUID
	GetUser(context.Context, *UUIDUser) (*User, error)
...
func (UnimplementedAuthCheckerServer) GetUser(context.Context, *UUIDUser) (*User, error) {
...
func _AuthChecker_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AuthChecker/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthCheckerServer).GetUser(ctx, req.(*UUIDUser))
	}
